...
# Initialize the model with and without dropout
model_without_dropout = CatDogClassifier(dropout_prob=0.0)  # No dropout
model_with_dropout = CatDogClassifier(dropout_prob=0.5)     # Dropout probability of 0.5
...
# Train the models with and without dropout
print("Training model without dropout:")
train_model(model_without_dropout, train_dataloader, val_dataloader, criterion, optimizer_without_dropout)

print("\nTraining model with dropout:")
train_model(model_with_dropout, train_dataloader, val_dataloader, criterion, optimizer_with_dropout)
